...
public class KeywordExtractorService {
    private static List<String> stopWords = Arrays.asList("january", "february", "march", "april", "may", "june", "july", "much", "seem",
            "september", "october", "november", "december", "''", "--", "'s", "``", "pm", "am", "their", "our",
