...
public class ConsumerServiceImpl implements ConsumerService {
    ...
    public ConsumerServiceImpl(KafkaConfig kafkaConfig, Consumer<String, Link> consumer, BlockingQueue<Link> messageQueue,
    ...
    public void run() {
        try {
            while (!closed.get()) {
                ConsumerRecords<String, Link> records = consumer.poll(Duration.ofMillis(kafkaConfig.getMaxPollDuration()));
