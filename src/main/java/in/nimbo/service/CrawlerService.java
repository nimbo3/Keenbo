...
public class CrawlerService {
    ...
    public CrawlerService(Cache<Object, Object> cache, KafkaService kafkaService, HBaseDAO hBaseDAO, ElasticDAO elasticDAO, ParserService parserService, Config config) {
        this.cache = cache;
